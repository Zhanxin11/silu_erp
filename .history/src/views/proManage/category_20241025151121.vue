 ...
 * @LastEditTime: 2024-10-25 15:10:34
    ...
    <el-row>
      ...
      <el-col :span="24">
        <el-table :data="tableData" border style="width: 100%" :header-cell-style="tableHeaderColor"
          ...
          <el-table-column prop="category1" label="产品线" :filters='categoryFiltervalue' :filter-method="catfilter">
          </el-table-column>
    ...
    computed: {
      ...
      category1FilterValue() {
        return this.catSelectForm.map(i => {
          if (i.childen) {
            i.childen.map(item => ({
              text: i.category1, value: i.category1
