 ...
 * @LastEditTime: 2024-10-24 17:16:08
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog class="dialog-box" :title="level==1?'修改大类':'修改产品线'" width="36%" :visible.sync="changeDialog">
      <el-form :inline="true" label-width="80px" :model="catChangeValue" ref="catChangeValue" :rules="spuFromRules">
        <el-form-item prop="category" label="大类">
          <el-select v-model="catChangeValue.oldVal" filterable allow-create clearable :disabled="changeMin">
            <el-option v-for="(i,index) in catOptions" :key="index" :label="i.category" :value="i.category">
            </el-option>
          </el-select>
        </el-form-item>
      </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      save() { },
      cancelCat() { this.changeDialog = false },
      // 表头颜色
