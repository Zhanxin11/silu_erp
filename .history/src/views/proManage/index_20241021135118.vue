 ...
 * @LastEditTime: 2024-10-21 13:50:00
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data=" tableData" id="table_out" ref="table" border style="width: 100%"
      ...
      @filter-change="proFilterChange()" :height="height">
      ...
      :summary-method="proSum" @filter-change="handleFilterChange"> -->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setHeight() {
        this.$nextTick(() => {
          this.height = innerHeight - 150px // 这里的X就是顶部栏的高度
        })
      }
    },
    created() {
