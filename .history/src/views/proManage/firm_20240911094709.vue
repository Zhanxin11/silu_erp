 ...
 * @LastEditTime: 2024-09-11 09:47:09
  ...
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="op" label="运营">
        <span v-for="(item, index) in scope.row.op" :key="index">
          {{ item }}
          <!-- 如果需要分隔符，可以添加逗号，但注意最后一个元素后不需要 -->
          <template v-if="index < scope.row.op.length - 1">, </template>
        </span>
      </el-table-column>
