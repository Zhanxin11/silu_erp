 ...
 * @LastEditTime: 2024-10-10 14:26:21
  ...
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog title="新增" :visible.sync="dialogVisible" width="48%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="proFormValues" ref="proFormValues" :rules="proRules">
        ...
        <el-form-item prop="store_brands_ops" label="商号" width="350px">
          <el-select v-model="proFormValues.store_brands_ops" placeholder="请选择商号" filterable collapse-tags>
            <el-option v-for="(item,index) in proForm.store_brands_ops" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
