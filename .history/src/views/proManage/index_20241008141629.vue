 ...
 * @LastEditTime: 2024-10-08 14:16:29
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column label="图片" prop='pics' align="center">
        <template slot-scope="scope">
          <div style="height: 100px; display: flex;justify-content: center; ">
            <el-image :src="'http://121.41.171.227:8000/' + scope.row.pics[0]" fit="fill"
              :alt="'http://121.41.171.227:8000/' + scope.row.pics[0]"></el-image>
          </div>
        </template>
      </el-table-column>
      ...
      <el-table-column prop='asin' label="子ASIN">
      </el-table-column>
