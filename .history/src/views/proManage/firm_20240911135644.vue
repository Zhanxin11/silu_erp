 ...
 * @LastEditTime: 2024-09-11 13:56:34
    ...
    <el-dialog title="新增商号" :visible.sync="dialog" width="35%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="firmForm">
        ...
        <el-form-item prop="name" label="店铺">
          <el-select v-model="nameValue" placeholder="请选择站点" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="name" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
