<template>
  <div class="app-container haplotype-detail default-scrollbar">
    <el-row style="padding-bottom: 20px">
      ...
      <el-button type="primary" @click="uploadSpuToExcel">下载上传Execl模板示例</el-button>
    </el-row>
    <el-row>
      <!-- <el-col :span="6">
      ...
      saveSpu(formName) {
        ...
        if (this.spuFromValues.id) {
          this.$refs[formName].validate(valid => {
            let putValue = this.spuFromValues.spu
            let putValue = this.spuFromValues.id
            if (valid) {
              putChangeCatApi(this.spuFromValues.spu).then(response => {
