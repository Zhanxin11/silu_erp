 ...
 * @LastEditTime: 2024-10-10 09:47:41
      ...
      <el-form :inline="true" label-width="80px" :model="proFormValues" ref="proFormValues" :rules="proRules">
        <el-form-item prop="store_brands_ops" label="商号">
          <!-- <el-cascader v-model="proFormValues.store_brands_ops" collapse-tags
            :props="{ checkStrictly: true,multiple: true, }" :options="opsValues" clearable>
          </el-cascader> -->
          <el-cascader v-model="proFormValues.store_brands_ops" collapse-tags :options="opsValues" clearable>
          </el-cascader>
        </el-form-item>
