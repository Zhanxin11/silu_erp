 ...
 * @LastEditTime: 2024-10-28 13:33:12
 * @FilePath: \vue-element-admin\src\views\proManage\firm.vue
 ...
 * @Date: 2024-09-04 17:37:16
 * @LastEditors: zhanxin11 749959696@qq.com
 * @LastEditTime: 2024-10-16 15:13:30
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" id="table_out" ref="table" border style="width: 100%"
      ...
      @filter-change="FirmfilterChange()" :summary-method="firmSum" show-summary>
      ...
      <el-table-column label="操作" align="center" class="editClass">
        <template slot-scope="scope">
      ...
      firmSum({ columns, data }) {
        ...
        columns.forEach((column, index) => {
          if (index === 0) {
            ...
            sums[index] = "总条数:" + this.tableData.length
            return
          }

          else if (index === 8) {
            sums[index] = "在售商号:" + isShow
            return
          }
          else if (index === 7) {
            sums[index] = "筛选条数:" + this.unitSum
            return
          }
