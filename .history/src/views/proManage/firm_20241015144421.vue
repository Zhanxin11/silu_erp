 ...
 * @LastEditTime: 2024-10-15 14:36:22
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" id ref="table" border style="width: 100%" @selection-change="handleSelectionChange"
      :header-cell-style="tableHeaderColor" @select="selectFirm" @filter-change="FirmfilterChange()"
      :summary-method="firmSum" show-summary>
