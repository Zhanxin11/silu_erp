 ...
 * @LastEditTime: 2024-10-08 16:12:09
    ...
    <el-dialog title="新增" :visible.sync="dialogVisible" width="48%" :inline="true">
      ...
      <el-form :inline="true" label-width="80px" :model="proForm">
        ...
        <el-form-item prop="status" label="产品状态" width="350px">
          <el-select v-model="firmFormValues.status" multiple placeholder="请选择运营(可多选)" filterable collapse-tags>
            <el-option v-for="(item,index) in firmForm.status" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
