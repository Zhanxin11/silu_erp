 ...
 * @LastEditTime: 2024-10-23 17:47:33
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog class="dialog-box" title="新增品类" width="25%" :visible.sync="spuDialog">
      <el-form :inline="true" label-width="80px" :model="spuFromValues" ref="spuFromValues" :rules="spuFromValues">
        <el-form-item prop="name" label="用户名">
          <el-input v-model="catSelectForm.category" placeholder="请输入用户名"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer">
