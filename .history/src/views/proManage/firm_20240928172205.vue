 ...
 * @LastEditTime: 2024-09-28 17:22:05
  ...
  export default {
    ...
    methods: {
      ...
      saveAddFirm(formName) {
        ...
        // const firmAddList = Object.keys(this.firmFormValues).forEach(key => {
        //   // 检查当前键对应的值是否为数组
        //   if (Array.isArray(obj[key])) {
        //     // 如果是数组，则将其转换为由逗号分隔的字符串
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            // alert('submit!')
            postAddFrimApi(this.firmAddList).then(response => {
