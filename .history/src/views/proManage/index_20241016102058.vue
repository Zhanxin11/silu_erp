 ...
 * @LastEditTime: 2024-10-16 10:09:38
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      catFilterValue() {
        console.log(this.tableData, 111, this.copyTableData)
        // return this.proFormValues.category.map(i => ({
        //   text: i.store, value: i.store
        // }))
      },
    },
    methods: {
      ...
      async initProData() {
        ...
        var copyTableData = this.tableData
