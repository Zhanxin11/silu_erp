 ...
 * @LastEditTime: 2024-10-11 14:58:24
  ...
  export default {
    ...
    data() {
      return {
        ...
        proRules: {
          ...
          category1: [{ required: true, msg: '请输入产品线', trigger: 'change' }],
          category2: [{ required: true, msg: '请输入细分线', trigger: 'change' }],
          spu_name: [{ required: true, validator: this.validateSpu, trigger: 'change' }],
    ...
    methods: {
      ...
      validateSpu(rule, value, callback) {
        console.log(rule, value, callback, 'spu')
        this.spus = this.proForm.spu
        console.log(console.log(rule, value, callback, 'spu'))
      },
      // 删除
      delProList() { },
      // 批量修改
