 ...
 * @LastEditTime: 2024-10-25 15:19:18
    ...
    <el-row>
      ...
      <el-col :span="24">
        <el-table :data="tableData" border style="width: 100%" :header-cell-style="tableHeaderColor"
          ...
          </el-table-column>category2FilterValue
          <el-table-column prop="category2" label="细分品线" :filters='category1FilterValue' :filter-method="catfilter">
          </el-table-column>
