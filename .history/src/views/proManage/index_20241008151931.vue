 ...
 * @LastEditTime: 2024-10-08 15:19:05
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%" :header-cell-style="tableHeaderColor">
      ...
      <el-table-column label="图片" prop='pic_pre' align="center" width="100">
        <template slot-scope="scope">
          <div style="height: 100px; display: flex;justify-content: center; ">
            <el-image :src="'http://192.168.5.174:8000' +scope.row.pic_pre" fit="fill"></el-image>
          </div>
        </template>
      </el-table-column>
    ...
    methods: {
      ...
      async initProData() {
        ...
        this.tableData.map(item => {
          console.log(item)
          if (item.pic_field) {
            item.pic_pic_field = ['http://192.168.5.174:8000' + item.pic_pre]
          } else {
            item.pic_pre = []
          }
          // return item.pic_pre
