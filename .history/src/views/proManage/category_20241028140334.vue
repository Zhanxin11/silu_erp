<template>
  <div class="app-container haplotype-detail default-scrollbar">
    <el-row style="padding-bottom: 20px">
      ...
      <el-button type="primary" @click="down2Excel">下载</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      down2Excel() {
        const tableId = 'table_out'
        const tableName = 'el-table__fixed-right'
        const routeName = this.$route.name || 'defaultName'
        console.log(tableName, routeName)
        downExcel(tableId, tableName, routeName)
      },
      downloadToExcel() { },
      // 表头颜色
