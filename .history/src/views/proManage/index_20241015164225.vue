 ...
 * @LastEditTime: 2024-10-15 16:42:19
    ...
    data() {
      return {
        ...
        proRules: {
          ...
          category2: [{ required: true, msg: '请输入细分线', trigger: '' }],
          spu: [{ required: true, validator: this.validateSpu, trigger: 'blchangeur' }],
          fasin: [{ required: true, msg: '请输细分线', trigger: 'blur' }],
          asin: [{ required: true, msg: '请输细分线', trigger: 'blur' }],
          sku: [{ required: true, msg: '请输细分线', trigger: 'blur' }],
          description: [{ required: true, msg: '请输细分线', trigger: 'blur' }],
          sell_date: [{ required: true, msg: '请输细分线', trigger: 'blur' }],
          status: [{ required: true, msg: '请输细分线', trigger: 'blur' }],
        }
      }
    },
    watch: {
