 ...
 * @LastEditTime: 2024-10-12 14:37:01
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%" :header-cell-style="tableHeaderColor" @select="selectFirm">
...
<script>
  import { getProductList, getProSelectList, postAddProApi, delProListApi } from '@/api/manage'
  export default {
