 ...
 * @LastEditTime: 2024-09-11 16:40:11
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange"
      ...
      <el-table-column prop="site1" label="站点" :filters='firmForm.site' :filter-method="siteFilter">
      </el-table-column>
      ...
      <el-form :inline="true" label-width="80px" :model="firmForm">
        <el-form-item prop="site" label="站点">
          <el-select v-model="siteValue" placeholder="请选择站点" filterable>
            <el-option v-for="(item,index) in siteFilterValue" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="name" label="商号">
          <el-select v-model="nameValue" placeholder="请选择商号" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="brand" label="品牌">
          <el-select v-model="nameValue" placeholder="请选择品牌" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="ops" label="运营">
          <el-select v-model="nameValue" placeholder="请选择运营" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="dp" label="部门">
          <el-select v-model="nameValue" placeholder="请选择部门" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="team" label="团队">
          <el-select v-model="nameValue" placeholder="请选择团队" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="unit1" label="小组">
          <el-select v-model="nameValue" placeholder="请选择小组" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="status" label="团队状态">
          <el-select v-model="nameValue" placeholder="请选择团队状态" filterable>
            <el-option v-for="(item,index) in firmForm.name" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
    ...
    data() {
      return {
        ...
        firmForm: {
          ...
          name: ['隆宁1店US', '隆宁6店US', '隆宁8店US', '测试店铺CA'],
        },
        siteValue: '',
        nameValue: '',
        brandValue: '',
