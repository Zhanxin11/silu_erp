 ...
 * @LastEditTime: 2024-10-10 14:29:59
    ...
    <el-dialog title="新增" :visible.sync="dialogVisible" width="50%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="proFormValues" ref="proFormValues" :rules="proRules">
        ...
        <el-form-item prop="brand" label="品牌" width="350px">
          <el-select v-model="proFormValues.brand" placeholder="请选择运营(可多选)" filterable collapse-tags>
            <el-option v-for="(item,index) in proForm.store_name" :key="index" :label="item"
              :value="item">
            </el-option>
          </el-select>
        </el-form-item>
