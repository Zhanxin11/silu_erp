 ...
 * @LastEditTime: 2024-10-25 10:20:33
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-row>
      <el-col :span="6">
        <el-tree :data="changeTree" show-checkbox node-key="id" default-expand-all :expand-on-click-node="false">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      changeTree() {
        console.log(this.catSelectForm)
        let a = this.catSelectForm.map(item => {
    ...
    methods: {
      async initData() {
        ...
        console.log(this.changeTree, 111)
      },
      // 字段校验
    ...
    mounted() {
      console.log(this.TreeData, this.catSelectForm)
