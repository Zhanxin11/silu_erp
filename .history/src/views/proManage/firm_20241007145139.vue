...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" ref="table" border :height="calc(76vh - 180px )" style="width: 100%"
      @selection-change="handleSelectionChange" :header-cell-style="tableHeaderColor" @select="selectFirm"
      @filter-change="FirmfilterChange()" show-summary :summary-method="tableFirmSum">
