 ...
 * @LastEditTime: 2024-09-29 10:33:12
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange"
      ...
      <el-table-column prop="status" label="商号状态" align="center">
        <template slot-scope="scope">
      ...
      <el-form :inline="true" label-width="80px" :model="firmFormValues" ref="firmFormValues" :rules="frimRules">
        ...
        <el-form-item prop="brand" label="品牌">
          <el-select v-model="firmFormValues.brands" multiple placeholder="请选择品牌" filterable>
            <el-option v-for="(item,index) in firmForm.brands" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item prop="op" label="运营" width="350px">
          <el-select v-model="firmFormValues.ops" multiple placeholder="请选择运营(可多选)" filterable>
            <el-option v-for="(item,index) in firmForm.ops" :key="index" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      validateName(rule, value, callback) {
        ...
        if (lastTwoDigits !== this.form.site) {
