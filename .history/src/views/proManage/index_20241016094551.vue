 ...
 * @LastEditTime: 2024-10-16 09:44:57
  ...
  export default {
    ...
    computed: {
      ...
      brandFilterValue() {
        ...
        this.proForm.store_brands_ops?.map(i => {
          const brandText = i.childen.brands[0]
          if (!brandMap.has(brandText)) {
            brandMap.set(brandText, true)
            brand.push({ text: brandText, value: brandText })
          }
        }
        )
        return brand
