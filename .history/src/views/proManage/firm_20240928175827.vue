 ...
 * @LastEditTime: 2024-09-28 17:58:27
    ...
    <el-dialog title="新增商号" :visible.sync="dialog" width="35%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="firmFormValues" ref="firmFormValues" :rules="frimRules">
        ...
        <el-form-item prop="op" label="运营" width="350px">
          <el-select v-model="firmFormValues.op" multiple placeholder="请选择运营(可多选)" filterable>
    ...
    data() {
      return {
        ...
        frimRules: {
          ...
          opValue: [{ required: true, message: '请选择运营', trigger: 'blur' },
          ],
