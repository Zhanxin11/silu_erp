<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog title="新增" :visible.sync="dialogVisible" width="50%" :inline="true">
      <el-form :inline="true" :label-position="labelPosition" label-width="80px" :model="proForm">
        <el-form-item label="图片" width="50%">
          <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/"
            ...
            :on-exceed="handleExceed" :file-list="fileList" show-file-list>
            <el-button size="small" type="primary">点击上传</el-button>
            <span slot="tip" class="el-upload__tip"  pre-wrap>只能上传jpg/png文件,大小500kb</span>
          </el-upload>
        </el-form-item>
