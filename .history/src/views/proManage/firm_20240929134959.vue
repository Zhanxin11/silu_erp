 ...
 * @LastEditTime: 2024-09-29 13:49:36
    ...
    <el-dialog title="新增商号" :visible.sync="dialog" width="35%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="firmFormValues" ref="firmFormValues" :rules="frimRules">
        ...
        <el-form-item prop="name" label="商号">
          <!-- <el-select v-model="firmFormValues.name" placeholder="请选择商号" filterable>
        ...
        <!-- <el-form-item prop="dp" label="部门">
          <el-select v-model="firmFormValues.dp" placeholder="请选择部门" filterable>
