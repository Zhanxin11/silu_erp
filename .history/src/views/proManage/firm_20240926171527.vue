 ...
 * @LastEditTime: 2024-09-26 17:14:45
  ...
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange"
      ...
      <el-table-column prop="dp" label="部门" :filters='dpFilterValue' :filter-method="opFilter">
        <template slot-scope="scope">
          <el-tag style="margin-right: 5px;margin-top: 5px;" v-for="op in scope.row.dp.dp" :key="op">{{ op
            }}</el-tag>
        </template>
      </el-table-column>
      </el-table-column>
      <el-table-column prop="team" label="团队" :filters='teamFilterValue' :filter-method="teamFilter">
        <template slot-scope="scope">
          <el-tag style="margin-right: 5px;margin-top: 5px;" v-for="op in scope.row.dp.children" :key="op">{{ op
            }}</el-tag>
        </template>
      </el-table-column>
