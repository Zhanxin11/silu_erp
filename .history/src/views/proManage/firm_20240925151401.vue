 ...
 * @LastEditTime: 2024-09-25 15:10:51
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog title="新增商号" :visible.sync="dialog" width="35%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="firmFormValues" :rules="frimRules">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveAddFirm(re)">确 定</el-button>
      </span>
    </el-dialog>
