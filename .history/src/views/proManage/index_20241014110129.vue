 ...
 * @LastEditTime: 2024-10-14 10:46:46
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog :title="proFormValues.pic==''?'新增' :'修改'" :visible.sync="dialogVisible" width="50%" :inline="true">
      ...
      saveAddPro(formName) {
        ...
        if (this.$refs[formName].sku == '') {
          ...
          if (this.proFormValues. pic == '') {
            delete this.proFormValues.pic
            console.log(this.proFormValues)
          }
          putChangeProApi(this)
        }
      },
      // 取消修改表单
      cancelPro() {
