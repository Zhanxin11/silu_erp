 ...
 * @LastEditTime: 2024-09-11 13:05:36
  ...
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-dialog title="新增" :visible.sync="dialog" width="50%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="firmForm">
        ...
        <el-form-item prop="op" label="品牌">
          <el-input></el-input>
        </el-form-item>
        <el-form-item prop="categories" label="运营">
          <el-input></el-input>
        </el-form-item>
        <el-form-item prop="proLine" label="部门">
          <el-input></el-input>
        </el-form-item>
        <el-form-item prop="minLine" label="团队">
          <el-input></el-input>
        </el-form-item>
        <el-form-item prop="SPU" label="小组">
          <el-input></el-input>
        </el-form-item>
        <el-form-item prop="fASIN" label="团队zhua">
          <el-input></el-input>
        </el-form-item>
      </el-form>
