 ...
 * @LastEditTime: 2024-10-07 14:30:35
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" ref="table" border style="width: 100%" @selection-change="handleSelectionChange"
      ...
      <el-table-column prop="site1" label="站点" :filters='siteFilterValue' :filter-method="siteFilter" width="100">
      </el-table-column>
      ...
      <el-table-column prop="ops" label="运营" width="300">
        <template slot-scope="scope">
          <el-tag style="margin-right: 5px;margin-top: 5px;" v-for="op in scope.row.ops">{{ op
            }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="dp" label="部门" :filters='dpFilterValue' :filter-method="opFilter">
        <template slot-scope="scope">
          <el-tag style="margin-right: 5px;margin-top: 5px;" v-for="k in scope.row.dp">{{ k.dp
            }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="team" label="团队" :filters='teamFilterValue' :filter-method="teamFilter">
        <template slot-scope="scope">
          <span style="margin-right: 5px;margin-top: 5px;" v-for="op in scope.row.dp">
            <span v-for="i in op.children">{{i.team}}</span>
          </span>
        </template>
      </el-table-column>
