...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%" :header-cell-style="tableHeaderColor">
      ...
      <el-table-column label="图片" prop='pics' align="center" width="100">
        <template slot-scope="scope">
          <div style="height: 100px; display: flex;justify-content: center; ">
            <el-image :src="'http://192.168.5.174:8000' + scope.row.pics[0]" fit="fill"
              :preview-src-list="'http://192.168.5.174:8000' + scope.row.pics[0]"></el-image>
          </div>
        </template>
      </el-table-column>
