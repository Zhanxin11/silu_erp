...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop='pics' label="大类">
      </el-table-column>
      <el-table-column prop='pics' label="产品线">
      </el-table-column>
      <el-table-column prop='pics' label="细分品线">
      </el-table-column>
      <el-table-column prop='pics' label="SPU">
      </el-table-column>
      <el-table-column prop='pics' label="父ASIN">
      </el-table-column>
      <el-table-column prop='pics' label="子ASIN">
      </el-table-column>
      <el-table-column prop='pics' label="SKU">
      </el-table-column>
      <el-table-column prop='pics' label="产品描述">
      </el-table-column>
      <el-table-column prop='pics' label="开售日期">
      </el-table-column>
      <el-table-column prop='pics' label="产品状态">
      </el-table-column>
      <el-table-column prop='pics' fixed="right" label="操作" width="150" align="center">
        <template slot-scope="scope">
