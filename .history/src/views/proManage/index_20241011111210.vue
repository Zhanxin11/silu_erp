 ...
 * @LastEditTime: 2024-10-11 11:12:10
    ...
    <el-dialog title="新增" :visible.sync="dialogVisible" width="50%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="proFormValues" ref="proFormValues" :rules="proRules">
        ...
        <el-form-item prop="brand_name" label="品牌" width="350px">
          <el-select v-model="proFormValues.brand_name" placeholder="请先选择商号" filterable collapse-tags
            style="width:92%"></el-select>
        ...
        <el-form-item prop="status" label="产品状态" width="350px">
          <el-select v-model="proFormValues.status" placeholder="产品状态" filterable collapse-tags style="width: 92%;">
    ...
    data() {
      return {
        ...
        proRules: {
          ...
          spu_name: [{ required: true, msg: '请输细分线', trigger: 'change' }],
