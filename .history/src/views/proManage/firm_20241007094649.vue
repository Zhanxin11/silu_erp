 ...
 * @LastEditTime: 2024-10-07 09:46:16
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data="tableData" ref="table" border style="width: 100%" @selection-change="handleSelectionChange"
      :header-cell-style="tableHeaderColor" @select="selectFirm" @filter-change="FirmfilterChange()" show-summary  summary-method="tableFirmSum">
