 ...
 * @LastEditTime: 2024-10-16 15:40:00
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-table :data=" tableData" id="table_out" border
      ...
      :page-sizes="[5, 10, 20,]" :page-size="100" layout="total, sizes, prev, pager, next, jumper" :total="400">
    </el-pagination> -->
