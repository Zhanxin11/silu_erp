 ...
 * @LastEditTime: 2024-10-24 13:28:10
    ...
    <el-dialog class="dialog-box" title="新增品类" width="36%" :visible.sync="spuDialog">
      <el-form :inline="true" label-width="80px" :model="spuFromValues" ref="spuFromValues" :rules="spuFromRules">
        ...
        <el-form-item prop="category1" label="产品线" filterable allow-create>
          <el-select v-model="spuFromValues.category1" placeholder="请输入" filterable collapse-tags>
        ...
        <el-form-item prop="category2" label="细分品线" filterable allow-create>
          <el-select v-model="spuFromValues.category2" placeholder="请输入" filterable collapse-tags>
        ...
        <el-form-item prop="spu" label="细分品线" filterable allow-create>
          <el-select v-model="spuFromValues.spu" placeholder="请输入" filterable collapse-tags>
    ...
    data() {
      return {
        ...
        spuFromRules: {
          ...
          spu: [{ required: false, validator: this.validateCategory2, trigger: 'blur' },]
        },
    ...
    methods: {
      ...
      validateCategory2(rule, value, callback) {
        if (this.spuFromValues.category1) {
          return callback(new Error('请输入已有的SPU,格式为xx-xx-xx'))
        }
      },
      addSpu() {
        this.spuDialog = true
