 ...
 * @LastEditTime: 2024-06-25 09:43:12
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        ...
        <el-button @click="dialogFormVisible = true" style="margin-right: 10px">增加</el-button>
      </el-row>
    ...
    <el-dialog title="增加" :visible.sync="dialogFormVisible">
      <el-form :model="formDate">
        <el-form-item v-for="([value,key], index) in formDate" :key="index" :label="key" :prop="value">
          <el-input v-model="formDate.value">{{value,key,index}}</el-input>
        </el-form-item>
      </el-form>
    ...
    methods: {
      async initData() {
        try {
          ...
          // 动态获取form
          this.formDate = await Object.keys(this.tableData[0]).reduce((newObj, key) => {
            newObj[key] = '' // 设置新对象的每个键的值为null
            return newObj
          }, {})
          console.log(this.tableData, this.formDate, 'cs')
        } catch (err) {
