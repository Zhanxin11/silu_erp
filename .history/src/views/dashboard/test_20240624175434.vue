 ...
 * @LastEditTime: 2024-06-24 17:53:45
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 动态获取form
      async getForm() {
        console.log(this.formDate, this.tableData, 111)
        this.formDate = await Object.keys(this.tableData[0]).reduce((newObj, key) => {
          newObj[key] = null // 设置新对象的每个键的值为null
          return newObj
        }, {})
        console.log(this.formDate, this.tableData)
    ...
    mounted() { this.$nextTick(this.getForm()) }
  };
</script>
