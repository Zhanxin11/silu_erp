  ...
  export default {
    ...
    methods: {
      ...
      changeDate(year, startMonth, month, start, end) {
        ...
        this.times = this.timeLength = this.empty
        console.log(this.times.length, this.timeLength.length)
      },
      generateParameterValues() {
        console.log(this.times.length, this.empty.length)
        return Array.from({ length: this.this.empty.length }, (_, i) =>
