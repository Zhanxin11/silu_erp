 ...
 * @LastEditTime: 2024-08-07 17:25:12
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="op_field" label="姓名" width="120">
        </el-table-column>
        <el-table-column label="SKU" prop="sku_field" width="120">
        </el-table-column>
        <el-table-column label="店铺" prop="store_field" width="120">
        </el-table-column>
        <el-table-column prop="2024-06-24" label="日期" width="120">
        </el-table-column>
