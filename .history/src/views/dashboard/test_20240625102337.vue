  ...
  <div class="app-container">
    ...
    <el-dialog title="增加" :visible.sync="dialogFormVisible">
      <el-form :model="formData">
        <el-form-item v-for="(value,key, index) in formData" label-width="100px" :key="index" :label="key||key!=id" :prop="value">
          <el-input v-model="formData[key]" style="width: 80%;"></el-input>
        </el-form-item>
      </el-form>
