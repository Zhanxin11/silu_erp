<template>
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        <el-select v-model="BusinesValue" class="select-Bus" multiple placeholder="请选择商号" filterable collapse-tags
...
<style lang="scss">
  ...
  .select-Bus input &::placeholder color #fff !important &::-webkit-input-placeholder color #fff !important
</style>
