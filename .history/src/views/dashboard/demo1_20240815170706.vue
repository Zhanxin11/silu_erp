 ...
 * @LastEditTime: 2024-08-15 16:58:46
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%;    height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <!-- <el-table-column v-for="(item) in dates" :key="item" :label="item" :prop="item">
        </el-table-column> -->
        <el-table-column v-for="(item) in tableData" :key="item" :prop="item" label="日期">
          <el-table-column v-for="i in item.date">
