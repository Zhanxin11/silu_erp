 ...
 * @LastEditTime: 2024-07-16 11:02:02
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        ...
        <el-row>
          <el-button @click="openDialog" style="margin:10px 10px  10px 0">增加{{spuOptions}}</el-button>
  ...
  export default {
    ...
    computed: {
      ...
      spuOptions() {
        ...
        const filteredOptions = this.tableData.filter(item => {
          console.log(item[key], '[key]')
          return item[key] === 'SPU'
        })
        console.log(filteredOptions, 'spuOptions')
