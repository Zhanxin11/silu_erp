 ...
 * @LastEditTime: 2024-08-09 10:36:24
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        ...
        <el-button type="sccces" @click="changeList">批量删除</el-button>
        <el-button type="primary" @click="changeList">新增</el-button>
      </el-row>
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        @selection-change="handleSelectionChange" @select="select" lazy="true">
