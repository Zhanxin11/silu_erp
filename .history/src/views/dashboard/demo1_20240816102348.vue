 ...
 * @LastEditTime: 2024-08-16 10:22:56
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        ...
        <el-button type="primary" v-if="isCheck" @click="uploadExcel">批量上传</el-button>
        <el-button type="primary" v-if="!isCheck" @click="">取消编辑</el-button>
