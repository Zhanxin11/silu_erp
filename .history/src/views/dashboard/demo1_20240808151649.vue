 ...
 * @LastEditTime: 2024-08-08 15:16:00
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <el-table-column prop="date.2024-06-24" label="date{2024-06-24"></el-table-column>
        <el-table-column label="日期">
          <template v-for="(i,k) in tableData">
            <el-table-column v-for="(item,key) in i.date" :label="key">{{item,key}}</el-table-column>
          </template>
