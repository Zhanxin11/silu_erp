  ...
  export default {
    ...
    methods: {
      ...
      changeDate(year, startMonth, month, start, end) {
        ...
        this.times = this.timeLength = empty
        console.log(this.times.length, this.timeLength.length)
      },
      generateParameterValues() {
        console.log(this.times.length, this.timeLength.length, 1111)
        return Array.from({ length: this.timeLength.length }, (_, i) =>
      ...
      addTrue() {
        ...
        return  item.values.forEach(innerItem => {
            console.log(innerItem)
            innerItem.isCheck = false
          })
        })
