  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" :data="tableData" border class="computed-table"
        ...
        <el-table-column fixed="right" prop="all" label="汇总" width="150" align="center">
          <template slot-scope="scope">
            <div :id="'main'+scope.row.id" style="width:70%;height:30px;margin: 0 auto;"></div>
          </template>
        </el-table-column>
    ...
    methods: {
      ...
      initEcharts() {
        this.stateList = this.tableData.map(item => {
          ...
          this.stateList.push(item.values)
        })
        console.log(this.tableData, this.stateList)
        this.$nextTick(function () {     for (let i = 0; i < this.stateList.length; i++) {
