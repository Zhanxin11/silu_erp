 ...
 * @LastEditTime: 2024-06-28 15:54:26
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData">
        ...
        <el-table-column fixed="right" prop="edit" label="操作">
          <template slot-scope="scope">
            ...
            <el-popconfirm style="padding: 0 10px;" confirm-button-text='好的' cancel-button-text='不用了' icon="el-icon-info" icon-color="red"
              title="这是一段内容确定删除吗？"> <el-button slot="reference" size="mini" type="danger"
