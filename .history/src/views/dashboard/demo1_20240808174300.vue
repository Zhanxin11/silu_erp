 ...
 * @LastEditTime: 2024-08-08 17:42:51
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <el-table-column prop="2024-06-25" label="2024-06-25"></el-table-column>
        <el-table-column v-for="date in dates" :key="date" :prop="date" :label="date">
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      dates() {
        if (this.productData && this.productData.date) {
        // 使用 Object.keys() 获取 date 对象的所有键
        return Object.keys(this.productData.date);
      }
      // 如果 productData 或 productData.date 不存在，返回空数组
      return [];
    }
      }
