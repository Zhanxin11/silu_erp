<template>
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        <el-form-item label="分配角色" prop="BusinesValue">
          <el-select v-model="roleStatus" multiple placeholder="请选择商号" filterable collapse-tags @change="selectPro"
  ...
  export default {
    data() {
      return {
        ...
        //   验证规则：
		 roleStatus:[
          	{required: true, message: "分配角色不能为空", trigger: ["blur",'change'],type: 'array'}
        ],
