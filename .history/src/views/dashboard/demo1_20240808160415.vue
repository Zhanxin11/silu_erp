 ...
 * @LastEditTime: 2024-08-08 15:59:27
...
<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table-column style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
      ...
      </el-table-column v-for="(time, index) in times" :key="index" :label="time" <el-table-column fixed="right"
        prop="edit" label="操作" width='150'>
