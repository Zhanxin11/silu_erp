  ...
  <div class="app-container">
    ...
    <el-dialog title="增加" :visible.sync="dialogFormVisible">
      <el-form :model="formData">
        <el-form-item v-for="(value,key, index) in formData" :key="index" :label="key||key!=id" :prop="value">
  ...
  export default {
    ...
    methods: {
      ...
      openDialog() {
        ...
        this.formData =  this.formData = await Object.keys(this.tableData[0]).reduce((newObj, key) => {
      },
