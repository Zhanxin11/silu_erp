 ...
 * @LastEditTime: 2024-08-07 17:43:12
...
<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"  @selection-change="handleSelectionChange">
