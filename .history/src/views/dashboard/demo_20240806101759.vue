  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" :data="tableData" border class="computed-table"
        ...
        <el-table-column fixed="right" label="汇总" prop="sum" width="250" align="center">
          <template slot-scope="scope">
            <div :id="'echarts_' + scope.$index" style="width: 95%; height: 50px; margin: 0 auto">
              <!-- {{ scope.$index }} -->
            </div>
          </template>
        </el-table-column>
