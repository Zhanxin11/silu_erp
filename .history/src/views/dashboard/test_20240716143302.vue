 ...
 * @LastEditTime: 2024-07-16 14:32:18
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        ...
        <el-select style="padding: 0 10px" v-model="spuValues" multiple collapse-tags filterable placeholder="请选择spu">
    ...
    methods: {
      ...
      selectAll(val) {
        ...
        if (selectValue.length < selectItem.length) {
          ...
          console.log(selectValue.length, selectItem.length)
          selectValue = []
        }
        if (val === 1) {
          this.spuValue = selectValue // 更新SPU的选中值
          console.log(this.spuValue)
        } else if (val === 2) {
          this.BusinesValue = selectValue // 更新Business的选中值
        }
      },
      // selectAll() {
