 ...
 * @LastEditTime: 2024-09-03 17:26:41
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table id="table_out" style="width: 100%; height: 100%;margin-top: 20px" border :data="tableData"
        ...
        <el-table-column prop="thumbnail_field
        " label="图片">
          <template slot-scope="scope">
            <div style="width: 100px;height: 100px;">
              <el-image :src="'http://121.41.171.227:8000/' + scope.row.thumbnail_field"
                :preview-src-list="'http://121.41.171.227:8000/'+ scope.row.pic_field"></el-image>
            </div>
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      //     const newItem = { ...item, images: [] }

      //     // 检查并添加pic_field（如果存在，则添加http前缀）
      //     if (item.pic_field) {
      //       newItem.images.push(`http://121.41.171.227:8000/${item.pic_field}`)
      //     }

      //     // 添加thumbnail_field
      //     if (item.thumbnail_field) {
      //       newItem.images.push(`http://121.41.171.227:8000/${item.thumbnail_field}`)
      //     }
