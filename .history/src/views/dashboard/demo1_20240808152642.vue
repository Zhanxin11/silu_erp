 ...
 * @LastEditTime: 2024-08-08 15:24:19
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <el-table-column prop="date.2024-06-24" label="2024-06-24"></el-table-column>
        <el-table-column label="日期">
          <template v-for="(i,k) in date">
            <el-table-column>{{i,k}}</el-table-column>
          </template>
    ...
    methods: {
      ...
      async initData() {
        ...
        try {
          ...
          this.date = this.tableData.map(item => {
