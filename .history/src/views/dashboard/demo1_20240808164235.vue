 ...
 * @LastEditTime: 2024-08-08 16:36:32
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <el-table-column prop :key="index" :label="item">
          </el-table-column>
          <el-table-column v-for="(item, index) in tableData.dates" :key="index" :label="item">
            {{item}},{{tableData.dates}}
          </el-table-column>
