 ...
 * @LastEditTime: 2024-08-08 14:57:47
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        @selection-change="handleSelectionChange" @select="select" v-for="(i,k) in tableData">
        ...
        <el-table-column label="日期" v-for="(item,key) in i.date">
          <el-table-column :label="key" prop="tem">{{item}}</el-table-column>
        </el-table-column>
