 ...
 * @LastEditTime: 2024-08-08 14:30:10
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <el-table-column label="日期" v-for="i in tableData">
          <el-table-column prop="i." label="2024-06-24"></el-table-column>
        </el-table-column>
        <el-table-column fixed="right" prop="edit" label="操作" width='100'>
    ...
    methods: {
      async initData() {
        ...
        try {
          ...
          const date = this.tableData.map(item => {
