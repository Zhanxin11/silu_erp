 ...
 * @LastEditTime: 2024-07-18 11:05:40
    ...
    <div class="filter-container">
      <el-row>
        <el-select v-model="BusinesValue" class="select-Bus" multiple placeholder="请选择商号(必选)" filterable collapse-tags
          @change="selectPro(BusinesValue,1)" @remove-tag="removeTag(1)">
        ...
        <el-select @change="selectPro(spuValues,4)" @remove-tag="removeTag(4)" style="padding: 0 10px"
