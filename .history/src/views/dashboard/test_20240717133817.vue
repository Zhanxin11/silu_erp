 ...
 * @LastEditTime: 2024-07-17 13:38:07
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      selectPro(val, num) {
        let selectItem
        let selectValue = [...val] // 复制数组以避免直接修改传入的val
