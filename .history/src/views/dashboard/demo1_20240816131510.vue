 ...
 * @LastEditTime: 2024-08-16 13:08:50
  ...
  <div class="app-container">
    <div class="filter-container">
      <el-row>
        ...
        <el-button type="primary" v-if="isCheck" @click="isCheck=true">取消编辑</el-button>
      ...
      <el-table style="width: 100%;    height: 100%; margin-top: 20px" border :data="tableData" id="table"
        ...
        <el-table-column v-for="(item,index) in dates" :key="item" :label="item" :prop="item">
          <template slot-scope="scope">
            <span v-if=" scope.row.date[index].is">{{ scope.row.date[index][item]}}</span>
            <el-input v-model="scope.row.date[index][item]"></el-input>
          </template>
        </el-table-column>
