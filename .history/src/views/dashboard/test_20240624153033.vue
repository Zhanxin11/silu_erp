  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table style="width: 100%; height: 100%; margin-top: 20px" border :data="tableData">
        ...
        <el-table-column prop="开始时间" label="开始时间" width="180"></el-table-column>
        <el-table-column prop="结束时间" label="结束时间" width="180"></el-table-column>
        <el-table-column prop="销量" label="结束时间" width="180"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
