 ...
 * @LastEditTime: 2024-06-25 09:49:39
  ...
  <div class="app-container">
    ...
    <el-dialog title="增加" :visible.sync="dialogFormVisible">
      <el-form :model="formData">
        <el-form-item v-for="(value,key, index) in formData" :key="index" :label="key" :prop="value">
          <el-input v-if="formData[key]==id" v-model="formData[key]"></el-input>
          <span>{{formData,value,key,index}}</span>
        </el-form-item>
      </el-form>
