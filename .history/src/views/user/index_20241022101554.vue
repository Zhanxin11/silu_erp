 ...
 * @LastEditTime: 2024-10-22 10:08:45
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table :data="tableData" border :header-cell-style="tableHeaderColor">
        ...
        <el-table-column prop="status" label="状态" align="center" fixed>:label="status?'在职':'离职'"
          <template slot-scope="scope">
            <el-tag size="mini" v-if="!scope.row.isEdit" @click="changeUser(scope.$index, scope.row)">编辑</el-tag>
          </template>
        </el-table-column>
