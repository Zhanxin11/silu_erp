  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table :data="tableData" :header-cell-style="tableHeaderColor"
        ...
        <el-table-column prop="icon" label="icon" align="center" fixed>
        </el-table-column>
        <el-table-column prop="sort" label="icon" align="center" fixed>
        </el-table-column>
        <el-table-column prop="per" label="icon" align="center" fixed>
        </el-table-column>
