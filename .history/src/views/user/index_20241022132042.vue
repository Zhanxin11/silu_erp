...
<template>
  <div class="app-container">
    ...
    <el-dialog class="dialog-box" title="新增用户" width="25%" :visible.sync="userDialog">
      <el-form :inline="true" label-width="80px" :model=" <el-form :inline="true" label-width="80px" :model="firmFormValues" ref="firmFormValues" :rules="frimRules">
        ...
        </el-form-item>" ref="firmFormValues" :rules="frimRules">
        <el-form-item prop="site" label="站点">
          <el-select v-model="firmFormValues.site" placeholder="请选择站点" filterable clearable>
            <el-option v-for="(item,index) in firmForm.site" :key="index" :label="item" :value="item">
            </el-option>
