 ...
 * @LastEditTime: 2024-10-31 17:27:43
        ...
        <el-form :inline="true" label-width="120px">
          ...
          <div v-if=" show===1">
            <el-form-item label="是否可见：">
              <el-switch v-model="isShowValue" active-color="#13ce66" inactive-color="#ff4949">
              </el-switch>
            </el-form-item>
            ...
            <el-form-item label="上级类目：">
              ...
              <el-cascader :show-all-levels="false" v-model="menuFrom.menuLocationValue" :options="options"
          ...
          <div v-if="show===2">
            ...
            <el-form-item label="上级类目：">
              ...
              <el-cascader v-model="menuFrom.menuLocationValue" :options="options" @change="handleChange"></el-cascader>
            </el-form-item>
            <el-form-item label="菜单路径：">
              <el-input v-model="menuFrom.urlValue" placeholder="请输入路径" style="width: 100%;"></el-input>
            </el-form-item>
            <el-form-item label="权限标识：">
              <el-input v-model="menuFrom.preValue" placeholder="请输入标识" style="width: 100%;"></el-input>
            </el-form-item>
          </div>
          <div v-if="show===3">
            <el-form-item label="是否可见：">
  ...
  export default {
    ...
    methods: {
      ...
      saveMenu() {
        ...
        console.log(this.menuFrom, this.menu, this.userChooseIcon)
      },
      handleChange() { },
      // 表头颜色
