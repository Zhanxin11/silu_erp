 ...
 * @LastEditTime: 2024-10-22 14:09:19
...
<template>
  <div class="app-container">
    ...
    <el-dialog class="dialog-box" title="新增用户" width="33%" :visible.sync="userDialog">
      <el-form :inline="true" ref label-width="80px" :model="listFrom" ref="listFrom" :rules="userRules">
        ...
        <el-form-item prop="status" label="状态">
          ...
          <el-select v-model="listFrom.status" multiple placeholder="请选择状态" filterable collapse-tags>
            <el-option v-for="(item,index) in userForm.status" :key="index" :label="item ? '在售' : '解约'" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveUser('List')">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
