 ...
 * @LastEditTime: 2024-10-29 09:52:18
    ...
    <el-dialog title="添加菜单" :visible.sync="dialogVisible" width="30%">
      <div>
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="用户管理" name="first">目录</el-tab-pane>
          <el-tab-pane label="配置管理" name="second">菜单</el-tab-pane>
          <el-tab-pane label="角色管理" name="third">按钮</el-tab-pane>
        </el-tabs>
      </div>
