 ...
 * @LastEditTime: 2024-10-29 17:26:55
      ...
      <div>
        <el-form>
          ...
          <el-form-item label="图标选择：">
            <!-- <template v-for="(name, index) in iconFontList" :index="index">
              <i :class="name"></i>
            </template> -->
            <!-- <el-select placeholder="请选择">
              <el-option v-for="item in iconFontList" :key="item" :label="item" :value="item">
                <i :class="item"></i>
              </el-option>
            </el-select> -->
            <div>
              <el-popover placement="top-start" width="450" trigger="click" v-model="visible">
                <span slot="reference"
                  style="display:inline-block;width:200px;height:40px;line-height:40px; border:1px solid #DCDFE6;">
