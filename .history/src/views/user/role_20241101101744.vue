...
<template>
  <div class="app-container">
    ...
    <el-dialog title="新增人员" :visible.sync="dialog" width="35%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="opFrom" ref="opFrom" :rules="frimRules">
        <el-form-item prop="op" label="站点">
          <!-- <el-select v-model="opFrom.op" placeholder="请选择部门" filterable clearable>
