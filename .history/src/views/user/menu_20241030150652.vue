 ...
 * @LastEditTime: 2024-10-30 15:06:52
...
<template>
  <div class="app-container">
    ...
    <el-dialog style="color: rgb(36, 34, 34); font-weight: 700;" title="添加菜单" :visible.sync="dialogVisible" width="28%">
      <div>
        <el-form :inline="true" label-width="120px">
          <el-form-item label="新增类型：">
            <el-button-group>
              <el-button size="mini" @click="changeMenu(1)">目录</el-button>
              <el-button size="mini" @click="changeMenu(2)">菜单</el-button>
              <el-button size="mini" @click="changeMenu(3)">按钮</el-button>
            </el-button-group>
          </el-form-item>
          <div v-if=" show===1">
            <el-form-item label="图标选择：">
              <el-popover placement="top-start" width="450" trigger="click" v-model="visible">
                <span slot="reference"
                  style="display:inline-block;width:180px;height:40px;line-height:40px; border:1px solid #DCDFE6;border-radius: 3px;">
                  <i style="margin: 10px;" :class="userChooseIcon"></i>
                  {{chooseIcons}}
                </span>
                选择目录图标
                <span class="iconList">
