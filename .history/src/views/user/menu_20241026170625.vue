 ...
 * @LastEditTime: 2024-10-26 17:01:07
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table :data="tableData" :header-cell-style="tableHeaderColor"
        ...
        <el-table-column label="icon"  label="icon" align="center" fixed>
        </el-table-column>
        <el-table-column label="sort"  label="icon" align="center" fixed>
        </el-table-column>
        <el-table-column label="per"  label="icon" align="center" fixed>
        </el-table-column>
