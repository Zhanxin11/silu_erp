 ...
 * @LastEditTime: 2024-10-22 13:50:43
...
<template>
  <div class="app-container">
    ...
    <el-dialog class="dialog-box" title="新增用户" width="35%" :visible.sync="userDialog">
      <el-form :inline="true" label-width="80px" :model="listFrom" ref="listFrom" :rules="userRules">
        ...
        <el-form-item prop="status" label="状态">
          ...
          <!-- <el-select v-model="listFrom.status" multiple placeholder="请选择状态" filterable collapse-tags>
            <el-option v-for="(item,index) in listFrom.brand" :key="index" :label="item" :value="item">
            </el-option>
          </el-select> -->
        </el-form-item>
      </el-form>
