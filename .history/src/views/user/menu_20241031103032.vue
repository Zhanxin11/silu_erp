      ...
      <div>
        <el-form :inline="true" label-width="120px">
          <el-form-item label="新增类型：">
            <el-button-group>
              <el-button size="mini" :plain="currSelect" @click="changeMenu(1)">目录</el-button>
              <el-button size="mini" :plain="currSelect" @click="changeMenu(2)">菜单</el-button>
              <el-button size="mini" :plain="currSelect" @click="changeMenu(3)">按钮</el-button>
            </el-button-group>
          </el-form-item>
          <div v-if=" show===1">
