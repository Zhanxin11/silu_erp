 ...
 * @LastEditTime: 2024-10-30 11:24:59
        ...
        <el-form>
          ...
          <el-form-item label="图标选择：">
            <el-popover placement="top-start" width="450" trigger="click" v-model="visible">
              <span slot="reference"
                style="display:inline-block;width:180px;height:30px;line-height:30px; border:1px solid #DCDFE6;border-radius: 3px;">
          ...
          <el-form-item label="菜单标题：">
            <el-input v-model="input" placeholder="请输入内容" width="180px"></el-input>
          </el-form-item>
        </el-form>
      </div>
