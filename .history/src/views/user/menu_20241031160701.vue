 ...
 * @LastEditTime: 2024-10-31 16:04:49
        ...
        <el-form :inline="true" label-width="120px">
          ...
          <div v-if=" show===1">
            ...
            <el-form-item label="上级类目：">
              ...
              <el-cascader :show-all-levels="false" v-model="menuFrom.menuLocationValue" :options="options" @change="handleChange" clearable></el-cascader>
            </el-form-item>
