 ...
 * @LastEditTime: 2024-10-29 16:42:39
        ...
        <el-form>
          ...
          <el-form-item label="图标选择：">
            ...
            <el-select v-model="value" placeholder="请选择">
              <el-option v-for="item in iconFontList" :key="item.value" :label="item.label" :value="item.value">
                <span style="float: left">{{ item.lbel }}</span>
