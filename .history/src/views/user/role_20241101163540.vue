 ...
 * @LastEditTime: 2024-11-01 16:35:19
  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-table :data="tableData" :header-cell-style="tableHeaderColor" row-key="id"
        ...
        <el-table-column fixed="right" label="操作" width="150" align="center">
          <template slot-scope="scope">
            <el-button size="mini" v-if="!scope.row.isEdit" @click="changeOp(scope.$index, scope.row)">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <el-dialog title="新增人员" :visible.sync="dialog" width="35%" :inline="true">
      <el-form :inline="true" label-width="80px" :model="opFrom" ref="opFrom" :rules="opRules">
        ...
        <el-form-item prop="der" label="主管">
          <el-input v-model="opFrom.derValue" clearable></el-input>
          </el-select>
        </el-form-item>
        <el-form-item prop="op" label="组员">
          <el-cascader :options="options" clearable></el-cascader>
          </el-select>
        </el-form-item>
