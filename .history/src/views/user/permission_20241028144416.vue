 ...
 * @LastEditTime: 2024-10-28 14:44:16
      ...
      <el-row>
        <el-col :span="17">
          <el-card shadow="never">
            <div slot="header" class="clearfix">
              <span style="color: #000000;font-weight: 700;">权限数据列表</span>
        ...
        <el-col :span="7">
          <el-card class="box-card" shadow="never">
            <div slot="header" class="clearfix">
              <span>菜单分配</span>
              <el-button style="float: right; padding: 3px 0" type="text"><el-button type="success" icon="el-icon-check" circle></el-button></el-button>
            </div>
