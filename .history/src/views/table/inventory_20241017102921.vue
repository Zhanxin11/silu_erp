 ...
 * @LastEditTime: 2024-10-17 10:29:04
...
<template>
  <div class="app-container haplotype-detail default-scrollbar">
    ...
    <el-row>
      <el-col :span="9.5" style="padding: 5px;"></el-col>
      <el-col :span="2" style="padding: 5px;text-align: right;">
        <el-tag>筛选结果：{{tableSum}}</el-tag>
      </el-col>
      <el-col :span="7.5" style="padding: 5px;text-align: right;">
